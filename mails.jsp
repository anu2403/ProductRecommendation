...
<%
String to1=session.getAttribute("c").toString();
String ps=session.getAttribute("totbill").toString();

String host="smtp.gmail.com",user="", pass="projectonly";
		...
		String subject = "Books Bill";
		String messageText = "Your Bill  Is : "+ps;
